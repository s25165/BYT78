...
public class Currency {
	...
	public Integer universalValue(Integer amount) {
		double tmp = (double) amount /100;
		return (int) (tmp*this.rate*100);
	}
	...
	public Integer valueInThisCurrency(Integer amount, Currency othercurrency) {
		//convert other currency to universal
		Integer amountUniversal = othercurrency.universalValue(amount);

		//change int representation to double and calculate amount in this currency based on rate
		Double amountUniversalDouble = (double)amountUniversal/100;
		Double amountThisCurrency = amountUniversalDouble/this.rate;
		return (int) (amountThisCurrency*100);
