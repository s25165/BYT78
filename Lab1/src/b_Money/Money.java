...
public class Money implements Comparable {
	...
	public Boolean equals(Money other) {
		...
		return Objects.equals(this.currency.universalValue(this.amount), other.currency.universalValue(other.amount));
	}
	...
	public Money add(Money other) {
		//change other money into global value
		Integer otherGlobal = other.currency.universalValue(other.amount);

		//change integer form into double
		Double otherGlobalDouble = (double) (otherGlobal/100);

		//get amount of local currency changed from global currency
		Double otherConverted = otherGlobalDouble/this.currency.getRate();

		//change double form into integer representation
		Integer otherConvertedInt = (int) (otherConverted*100);

		return new Money(this.amount+otherConvertedInt,this.currency);
	...
	public int compareTo(Object other) {
		Money m = (Money)other;
		return (this.universalValue()).compareTo(m.universalValue());
	}
}